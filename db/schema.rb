...
ActiveRecord::Schema.define(version: 2018_09_19_114424) do
  ...
  create_table "watchlist_memberships", force: :cascade do |t|
    t.integer "user_id", null: false
    t.integer "company_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["company_id"], name: "index_watchlist_memberships_on_company_id"
    t.index ["user_id"], name: "index_watchlist_memberships_on_user_id"
  end
